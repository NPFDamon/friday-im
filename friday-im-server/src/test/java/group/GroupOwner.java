...
public class GroupOwner {
    ...
    public static void main(String[] args) throws Exception {
        ...
        GroupOutParam groupInfo = HttpTest.group(members);
        log.info("group:{}", JsonHelper.toJsonString(groupInfo));
        loginAndSendMessage(groupInfo.getGroupId());
    }

    public static void loginAndSendMessage(String groupId) throws InterruptedException {
        ...
        b.group(group)
                ...
                .handler(new ChannelInitializer<SocketChannel>() {
                    ...
                    public void initChannel(SocketChannel ch) throws Exception {
                        ...
                        pipeline.addLast(new GroupOwnerHandler("owner", groupId));
                    }
                });
        b.connect(HOST, PORT);
    }
